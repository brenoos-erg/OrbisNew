      ...
      <header className="space-y-3 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <div className="flex flex-col items-start gap-3 sm:flex-row sm:justify-between">
          ...
          <a
            ...
            className="inline-flex w-full items-center justify-center rounded-full bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-slate-800 sm:w-auto"
          >
            Check-in rápido
          </a>
        </div>
