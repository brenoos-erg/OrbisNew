...
export default function SolicitacoesPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--card)] text-[var(--foreground)]">
      {/* Header */}
      ...
      <div className="overflow-x-auto border rounded-lg">
        <table className="min-w-full text-sm">
          <thead className="bg-slate-100 text-[var(--muted-foreground)]">
            <tr>
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={5} className="text-center py-6 text-[var(--muted-foreground)]">
                  Carregando...
                </td>
              </tr>
            ) : filtered.length === 0 ? (
              ...
              filtered.map((item) => (
                <tr
                  key={item.id}
                  className="border-t hover:bg-[var(--card-muted)] transition-colors"
                >
                  ...
                  <td className="px-4 py-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded border border-[var(--input-border)] bg-[var(--card)] px-2 py-1 text-xs font-semibold text-[var(--foreground)] hover:bg-[var(--card-muted)]"
                    >
