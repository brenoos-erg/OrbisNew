    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="rounded-xl border border-slate-200 bg-white/60 p-4 mb-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            <label className="block text-xs font-semibold text-black uppercase tracking-wide">Linhas</label>
      ...
      <div className="rounded-xl border border-slate-200 bg-white/60">
        ...
        <div className="flex items-center justify-between p-3 border-t text-sm">
          <div className="text-slate-500">
            Exibindo {rows.length ? (page - 1) * pageSize + 1 : 0}–{Math.min(page * pageSize, total)} de {total}
          </div>
          <div className="flex items-center gap-2">
            <button
            ...
            <span className="px-1">Página {page} / {totalPages}</span>
            <button
              className="rounded-md border px-3 py-1 hover:bg-slate-50 disabled:opacity-50"
        ...
        <div className="fixed inset-0 bg-black/40 grid place-items-center z-50">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-6 flex justify-end gap-2">
              ...
              <button onClick={create} className="inline-flex items-center gap-2 rounded-md bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-950">
                <Save size={16}/> Salvar
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/40 grid place-items-center z-50">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-6 flex justify-end gap-2">
              ...
              <button onClick={saveEdit} className="inline-flex items-center gap-2 rounded-md bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-950">
                <Save size={16}/> Salvar
              </button>
            </div>
          </div>
