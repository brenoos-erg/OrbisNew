...
const categories = [
  ...
  { value: 'LINHA_TELEFONICA', label: 'Linha telefônica' },
...
function formatCostCenter(cc?: { description: string | null; externalCode: string | null; code: string | null } | null) {
...
export default function TiEquipmentsPage() {
  ...
  const currentCategoryLabel =
    categories.find((c) => c.value === categoryFilter)?.label || 'Todos'

  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Controle de Equipamentos TI</h1>
          <p className="text-sm text-slate-500">
            Inventário e status de equipamentos por categoria.
          </p>
        </div>
        ...
        <div className="rounded-lg border bg-white p-4 shadow-sm">
          ...
          {!selected ? (
            ...
            <div className="mt-4 space-y-2 text-sm">
              ...
              <DetailRow label="Categoria" value={categories.find((c) => c.value === selected.category)?.label || selected.category} />
