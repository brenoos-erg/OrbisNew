...
import { Ban, BellRing, CheckCheck, ClipboardCheck, FileCheck2, Files, History } from 'lucide-react'
...
const TABS: TabItem[] = [
  ...
  { href: '/dashboard/controle-documentos/cancelados', label: 'Documentos Cancelados', icon: Ban },
