  ...
  const tiposTiCatalogo = [
    ...
    },
    {
      ...
      camposEspecificos: [
        ...
        { name: 'acessoriosNecessarios', label: 'Acessórios necessários', type: 'multiselect', options: ['Mochila', 'Mouse', 'Teclado', 'Headset', 'Adaptador HDMI/VGA/USB-C', 'Nobreak/Filtro de linha', 'Carregador/fonte', 'Outro'], stage: 'solicitante', section: 'Acessórios' },
        { name: 'descricaoAcessoriosOutros', label: 'Descreva outros acessórios (obrigatório quando selecionar Outro)', type: 'textarea', stage: 'solicitante', section: 'Acessórios' },
