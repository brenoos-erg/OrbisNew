  ...
  const tiposTiCatalogo = [
    ...
    },
    {
      ...
      camposEspecificos: [
        ...
        { name: 'descricaoEquipamentoOutro', label: 'Descreva o equipamento necessário (quando for Outro)', type: 'textarea', stage: 'solicitante', section: 'Equipamento' },
        { name: 'descricaoPeriferico', label: 'Descreva o periférico (obrigatório quando selecionar Periféricos)', type: 'textarea', stage: 'solicitante', section: 'Equipamento' },
        ...
        { name: 'precisaMochila', label: 'Precisa de mochila?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'precisaMouse', label: 'Precisa de mouse?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'precisaTeclado', label: 'Precisa de teclado?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'precisaHeadset', label: 'Precisa de headset?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'precisaAdaptador', label: 'Precisa de adaptador HDMI/VGA/USB-C?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'precisaCarregadorFonte', label: 'Precisa de carregador/fonte?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'precisaOutroAcessorio', label: 'Precisa de outro acessório?', type: 'checkbox', stage: 'solicitante', section: 'Acessórios notebook' },
        { name: 'descricaoOutroAcessorio', label: 'Se sim, descrever outro acessório', type: 'textarea', stage: 'solicitante', section: 'Acessórios notebook' },
