 ...
 if (rhDepartment) {
  ...
  const tiposTiCatalogo = [
    ...
    },
    {
      ...
      requiresApproval: true,
      camposEspecificos: [
        { name: 'tipoRecurso', label: 'Tipo de recurso', type: 'select', required: true, options: ['Notebook', 'Desktop', 'Monitor', 'Smartphone', 'Linha telefônica', 'Chip', 'Ramal', 'Impressora', 'Roteador/TP-Link', 'Periférico', 'Outro'], stage: 'solicitante', section: 'Recurso' },
        { name: 'tipoSolicitacaoRecurso', label: 'Tipo de solicitação do recurso', type: 'select', required: true, options: ['Novo recurso', 'Substituição', 'Manutenção', 'Devolução', 'Transferência', 'Bloqueio', 'Desbloqueio', 'Cancelamento', 'Portabilidade', 'Alteração de plano'], stage: 'solicitante', section: 'Recurso' },
        { name: 'colaboradorBeneficiado', label: 'Colaborador beneficiado', type: 'text', stage: 'solicitante', section: 'Dados operacionais' },
        { name: 'patrimonioOuLinha', label: 'Patrimônio ou linha', type: 'text', stage: 'solicitante', section: 'Dados operacionais' },
        { name: 'centroDeCusto', label: 'Centro de custo', type: 'cost_center', stage: 'solicitante', section: 'Dados operacionais' },
        { name: 'localEntregaOuRetirada', label: 'Local de entrega/retirada', type: 'text', stage: 'solicitante', section: 'Dados operacionais' },
        { name: 'dataNecessaria', label: 'Data necessária', type: 'date', stage: 'solicitante', section: 'Dados operacionais' },
        { name: 'motivo', label: 'Motivo', type: 'textarea', required: true, stage: 'solicitante', section: 'Justificativa' },
        ...
        { name: 'justificativa', label: 'Justificativa', type: 'textarea', stage: 'solicitante', section: 'Justificativa' },
        { name: 'fotosOuAnexos', label: 'Fotos/anexos', type: 'file', stage: 'solicitante', section: 'Evidências' },
        { name: 'equipamentoVinculado', label: 'Payload integração equipamento/linha', type: 'text', stage: 'solicitante', section: 'Integração futura' },
      ],
    },
    {
      id: 'RQ_TI_004',
