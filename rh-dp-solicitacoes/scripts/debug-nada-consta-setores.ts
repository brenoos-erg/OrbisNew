...
async function main() {
  ...
  const posFiltro = applyReceivedSectorVisibilityFilter(visiveisPolitica as any, { normalizedSectorNames: access.userSectorNamesNormalized, userDepartmentIds: access.userDepartmentIds, userCostCenterIds: access.userCostCenterIds, userDepartmentNamesNormalized: access.userDepartmentNamesNormalized, userSectorNamesNormalized: access.userSectorNamesNormalized, viewerTipoIds: access.viewerTipoIds, userSetorKeys: access.userSetorKeys, userId: me.id, finalizerTipoIds: access.finalizerTipoIds, isExperienceEvaluationCoordinator: access.isExperienceEvaluationCoordinator, isRhAuthorizedForExperienceEvaluation: access.isRhAuthorizedForExperienceEvaluation })
